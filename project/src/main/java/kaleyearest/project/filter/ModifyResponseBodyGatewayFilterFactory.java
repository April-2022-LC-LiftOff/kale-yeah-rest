package kaleyearest.project.filter;
...
public class ModifyResponseBodyGatewayFilterFactory
    ...
    public ModifyResponseBodyGatewayFilterFactory(Set<MessageBodyDecoder> messageBodyDecoders, Set<MessageBodyEncoder> messageBodyEncoders) {
        super(Config.class);
